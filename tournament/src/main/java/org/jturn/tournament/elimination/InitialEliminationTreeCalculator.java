 ...
 *
 */
final class InitialEliminationTreeCalculator {

	private final int numberOfPlayers;
	
	InitialEliminationTreeCalculator(int numberOfPlayers) { 
		checkArgument(numberOfPlayers > 1, "Number of players must be greater that one");
		checkArgument(ByeCalculator.isPowerOfTwo(numberOfPlayers), "Number of players must be power of two, e.g. 2, 4, 8, 16, 32...");
